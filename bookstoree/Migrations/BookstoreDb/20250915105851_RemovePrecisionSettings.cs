...
{
    /// <inheritdoc />
    public partial class RemovePrecisionSettings : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_DiscountCode_Dates", "[EndDate] >= [StartDate]");
                    table.CheckConstraint("CK_DiscountCode_MinimumOrder_NonNegative", "[MinimumOrder] >= 0");
                    table.CheckConstraint("CK_DiscountCode_Value_NonNegative", "[Value] >= 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Book_Price_NonNegative", "[Price] >= 0");
                    table.CheckConstraint("CK_Book_Stock_NonNegative", "[StockQuantity] >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_DiscountCodes_DiscountCode",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderDetails_OrderId_BookId",
                table: "OrderDetails",
